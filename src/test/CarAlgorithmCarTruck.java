 ...
 * @author Gaya Mehenni
 */
public class CarAlgorithmCarTruck {

    private static String trainingPath = "D:\\Cegep\\Session_4\\IA Data\\Dataset_Voiture_Camion\\training";
    private static String testingPath = "D:\\Cegep\\Session_4\\IA Data\\Dataset_Voiture_Camion\\testing";
    private static String savingPath = "D:\\Cegep\\Session_4\\IA Data\\Network Saves\\trained_network_car_truck";
    private static double learningRate = 0.001;
    private static int numberOfEpochs = 20;
    ...
    public static void main(String[] args) {
        ...
        NeuralNetwork nn = new NeuralNetwork(ActivationFunctions.Sigmoid, 28 * 28 * 3, 48, 24, 2);
        ...
        for(int i = 0; i < folders.size(); i++) {
            ...
            for(int j = 0; j < images.size(); j++) {
                ...
                try {
                    ...
                    double[] expected = CarAI.getOutputFromString2Vehicles(type, nn.getOUTPUT_LAYER_SIZE());
        ...
        for(int epoch = 0; epoch < numberOfEpochs; epoch++) {
            ...
            for(int data = 0; data < epochData.size(); data++) {
                ...
                try {
                    ...
                    double[] output = CarAI.getOutputFromString2Vehicles((String) dataElement.getLabel(), nn.getOUTPUT_LAYER_SIZE());
                    ...
                    if (data % batch_size == 0) {
                        nn.updateWeightsAndBiases(learningRate);
                    }
