...
public class Layer implements Serializable {
    ...
    private Matrix weights, outputs, outputsZ, outputsS, inputs, biases, errors;
    ...
    public Layer(int nbNeurons, int inputNeurons, LayerType type, ActivationFunctions function) {
        ...
        outputsS = new Matrix(NB_NEURONS, 1);
    ...
    public void feedForward() {
        ...
        if (type != LayerType.InputLayer) {
            ...
            if (function == ActivationFunctions.Softmax) {
                outputsS = outputsZ.applyFunction(function);

                SoftmaxFunction sf = new SoftmaxFunction();
                Matrix o = new Matrix(outputsS.getROWS(), outputsS.getCOLS());
                for (int i = 0; i < outputsS.getROWS(); i++) {
                    o.setElement(i, 0, sf.getValue(outputsS, i));
                }
    ...
    /**
     * Methode qui retourne les sorties avant la fonction softmax
     * @return sorties
     */
    public Matrix getOutputsS() {
        return outputsS;
    }

    /**
     * Methode qui change les sorties avant la fonction softmax
     * @param outputsS sorites
     */
    public void setOutputsS(Matrix outputsS) {
